...
let HandleArgs argv =
    ...
    let compiler = CompilerInstance()
    let options = { LexerTrace = false; ParserTrace = false; DumpAst = false }
    ...
    for arg in argv do
        ...
        | "-h" | "--help" -> 
            ...
            printfn "  -ast-dump - Dump Ast as json"
